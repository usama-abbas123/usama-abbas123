...
🧩 Full-Stack Web Development with the **MERN Stack** (MongoDB, Express.js, React.js, Node.js)

🐍 **Python Backend** Development for APIs, automation, and data-driven systems

🗃️ Database Design & Optimization using MySQL, **MongoDB**, and SQLite

🎨 Frontend Engineering with a focus on clean UI/UX using **React, Tailwind CSS**, and Framer Motion
